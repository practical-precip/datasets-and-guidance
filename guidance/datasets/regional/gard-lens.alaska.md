...
evidence:
  - statement: >-
      The authors capped Alaska GMET training precipitation at 500 mm/day and regridded it from a 2
      km curvilinear grid to an approximately 4 km rectilinear grid.
    paper: hartke-gard-lens
    locator: 'Methods: Observation data.'
    scope: >-
      Processing of Alaska training observations, not a stated maximum imposed on every projected
      GARD-LENS value.
---
