...
| --- | --- |
| Family | observation |
| Description | Analysis of Record for Calibration forcing analysis. Select release and native versus National Water Model grid. |
...
| --- | --- |
| Value | 30 |
| Unit | arc-seconds (approximately 800 m) |
...
| Field | Value |
| --- | --- |
| Landing Page | https://registry.opendata.aws/noaa-nws-aorc/ |
| Data | https://registry.opendata.aws/noaa-nws-aorc/ |
...
| Url | Locator |
| --- | --- |
| https://registry.opendata.aws/noaa-nws-aorc/ | Provider/project description: identity and core properties summarized above. Unstated fields remain unknown. |
...
| --- | --- | --- |
| Provider or identification lead | https://registry.opendata.aws/noaa-nws-aorc/ | Resolve the release and availability before selecting data. |
