...
| Name | CMIP6 |
| Kind | collection |
| Provider | WCRP / participating modeling centers |
...
| --- | --- |
| Family | collection |
| Description | An intercomparison archive with many models, experiments and grids. Select source, experiment, member and grid IDs before comparing files. |
...
| Field | Value |
| --- | --- |
| Landing Page | https://wcrp-cmip.org/cmip-phases/cmip6/ |
| Data | https://wcrp-cmip.org/cmip-phases/cmip6/ |
...
| Url | Locator |
| --- | --- |
| https://wcrp-cmip.org/cmip-phases/cmip6/ | Provider/project description: identity and core properties summarized above. Unstated fields remain unknown. |
...
| --- | --- | --- |
| Provider or identification lead | https://wcrp-cmip.org/cmip-phases/cmip6/ | Resolve the release and availability before selecting data. |
...
An intercomparison archive with many models, experiments and grids. Select source, experiment, member and grid IDs before comparing files.
