...
| Summary | Land-model replay forced by ERA5. It is not an independent atmospheric model ensemble. |
...
| Guidance | product-guidance/era5-land.md |
...
| --- | --- |
| Family | reanalysis |
| Description | Land-model replay forced by ERA5. It is not an independent atmospheric model ensemble. |
...
| Field | Value |
| --- | --- |
| Landing Page | https://www.ecmwf.int/en/era5-land |
| Data | https://www.ecmwf.int/en/era5-land |
...
| Url | Locator |
| --- | --- |
| https://www.ecmwf.int/en/era5-land | Provider/project description: identity and core properties summarized above. Unstated fields remain unknown. |
...
| --- | --- | --- |
| Provider or identification lead | https://www.ecmwf.int/en/era5-land | Resolve the release and availability before selecting data. |

## Expert Guidance

| Field | Value |
| --- | --- |
| Title | ERA5-Land guidance |
...
Land-model replay forced by ERA5. It is not an independent atmospheric model ensemble.
