...
| --- | --- |
| Family | collection |
| Description | CMIP6 high-resolution intercomparison with atmosphere-only and coupled experiments. There is no single grid or pooled member count. |
...
| Historical | Common protocol periods include 1950-2050; inspect experiment |
...
| --- | --- |
| Value | (not recorded) |
| Unit | model and experiment dependent |
...
| Field | Value |
| --- | --- |
| Landing Page | https://highresmip.org/ |
| Data | https://highresmip.org/ |
...
| Url | Locator |
| --- | --- |
| https://highresmip.org/ | Provider/project description: identity and core properties summarized above. Unstated fields remain unknown. |
...
| --- | --- | --- |
| Provider or identification lead | https://highresmip.org/ | Resolve the release and availability before selecting data. |

## Expert Guidance

| Field | Value |
| --- | --- |
| Title | HighResMIP guidance |
