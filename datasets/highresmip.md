...
- __Id:__ highresmip
- __Name:__ HighResMIP
- __Kind:__ collection
- __Provider:__ WCRP / participating modeling centers
- __Version:__ Family record; select a specific release or experiment before using data.
- __Summary:__ CMIP6 high-resolution intercomparison with atmosphere-only and coupled experiments. There is no single grid or pooled member count.
...
- __Description:__ CMIP6 high-resolution intercomparison with atmosphere-only and coupled experiments. There is no single grid or pooled member count.
...
- __Historical:__ Common protocol periods include 1950-2050; inspect experiment
...
- __Unit:__ model and experiment dependent
...
- __Landing Page:__ https://highresmip.org/
- __Data:__ https://highresmip.org/
...
1. __Url:__ https://highresmip.org/
...
CMIP6 high-resolution intercomparison with atmosphere-only and coupled experiments. There is no single grid or pooled member count.
