...
| --- | --- |
| Family | reanalysis |
| Description | Global reanalysis. Distinguish precipitation diagnostics and collection names when selecting data. |
...
| Field | Value |
| --- | --- |
| Landing Page | https://gmao.gsfc.nasa.gov/gmao-products/merra-2/ |
| Data | https://gmao.gsfc.nasa.gov/gmao-products/merra-2/ |
...
| Url | Locator |
| --- | --- |
| https://gmao.gsfc.nasa.gov/gmao-products/merra-2/ | Provider/project description: identity and core properties summarized above. Unstated fields remain unknown. |
...
| --- | --- | --- |
| Provider or identification lead | https://gmao.gsfc.nasa.gov/gmao-products/merra-2/ | Resolve the release and availability before selecting data. |

## Expert Guidance

| Field | Value |
| --- | --- |
| Title | MERRA-2 guidance |
...
Global reanalysis. Distinguish precipitation diagnostics and collection names when selecting data.
