...
- __Provider:__ NCEP / River Forecast Centers
- __Version:__ Family record; select a specific release or experiment before using data.
- __Summary:__ Radar and gauge precipitation analysis. Check accumulation duration, coverage and processing changes before climate comparisons.
...
- __Description:__ Radar and gauge precipitation analysis. Check accumulation duration, coverage and processing changes before climate comparisons.
...
- __Domain:__ US radar/forecast-center analysis domain
- __Grid:__ Inspect the selected distribution; the nominal resolution does not specify coordinates.
- __Timestep:__ Accumulation interval depends on product
- __Historical:__ Archive and accumulation dependent
...
- __Landing Page:__ https://www.emc.ncep.noaa.gov/mmb/research/stage4.FAQ.html
- __Data:__ https://www.emc.ncep.noaa.gov/mmb/research/stage4.FAQ.html
...
1. __Url:__ https://www.emc.ncep.noaa.gov/mmb/research/stage4.FAQ.html
...
1. __Label:__ Provider or identification lead
   - __Url:__ https://www.emc.ncep.noaa.gov/mmb/research/stage4.FAQ.html
   - __Description:__ Resolve the release and availability before selecting data.

## Expert Guidance

- __Title:__ Stage IV guidance
