...
- __Provider:__ WCRP / regional modeling centers
- __Version:__ Family record; select a specific release or experiment before using data.
- __Summary:__ Regional climate downscaling coordination across domains and generations. The existing NA-CORDEX record is one regional collection, not the whole program.
...
- __Family:__ collection
- __Description:__ Regional climate downscaling coordination across domains and generations. The existing NA-CORDEX record is one regional collection, not the whole program.
...
- __Domain:__ Multiple regional domains worldwide
- __Grid:__ Inspect the selected distribution; the nominal resolution does not specify coordinates.
- __Timestep:__ Variable and experiment dependent
- __Historical:__ Domain and generation dependent
...
- __Unit:__ domain and experiment dependent
...
- __Landing Page:__ https://cordex.org/
- __Data:__ https://cordex.org/
