...
| Description | Raw CESM large ensembles, distinct from downscaled GARD-LENS. CESM1 LENS and CESM2 LENS2 require separate generation selection. |
...
| Timestep | Variable and collection dependent |
| Historical | Generation dependent |
...
| Field | Value |
| --- | --- |
| Landing Page | https://www.cesm.ucar.edu/community-projects/lens |
| Data | https://www.cesm.ucar.edu/community-projects/lens |
...
| Url | Locator |
| --- | --- |
| https://www.cesm.ucar.edu/community-projects/lens | Provider/project description: identity and core properties summarized above. Unstated fields remain unknown. |
...
| --- | --- | --- |
| Provider or identification lead | https://www.cesm.ucar.edu/community-projects/lens | Resolve the release and availability before selecting data. |
| CESM2 Large Ensemble | https://www.cesm.ucar.edu/community-projects/lens2 | Alternative generation; do not silently substitute for CESM1. |

## Expert Guidance

| Field | Value |
| --- | --- |
| Title | CESM-LENS guidance |
...
Raw CESM large ensembles, distinct from downscaled GARD-LENS. CESM1 LENS and CESM2 LENS2 require separate generation selection.
