...
| Guidance | product-guidance/maca-metdata.md |
...
| Reference Dataset | gridMET (METDATA) |
| Training Period | 1979-2012 reference record. This is the available reference-record span, not a confirmed calibration window. The provider FAQ also describes 1979-2009 training statistics; confirm the exact MACAv2 configuration. |
...
| Unit | degrees (1/24 degree, approximately 4 km) |
...
| --- | --- | --- |
| pr | mm (daily amount in the Earth Engine distribution) | Precipitation. Confirm whether the selected variable is a rate or accumulated amount. |
...
| Field | Value |
| --- | --- |
| Title | MACAv2-METDATA evaluation guidance |
