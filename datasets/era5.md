...
| Summary | Global atmospheric reanalysis. Native and regridded distributions have different grids. |
...
| Guidance | product-guidance/era5.md |
...
| --- | --- |
| Family | reanalysis |
| Description | Global atmospheric reanalysis. Native and regridded distributions have different grids. |
...
| --- | --- |
| Value | 31 |
| Unit | km nominal native atmospheric grid |
...
| Field | Value |
| --- | --- |
| Landing Page | https://www.ecmwf.int/en/forecasts/datasets/complete-era5-global-atmospheric-reanalysis |
| Data | https://www.ecmwf.int/en/forecasts/datasets/complete-era5-global-atmospheric-reanalysis |
...
| Url | Locator |
| --- | --- |
| https://www.ecmwf.int/en/forecasts/datasets/complete-era5-global-atmospheric-reanalysis | Provider/project description: identity and core properties summarized above. Unstated fields remain unknown. |
...
| --- | --- | --- |
| Provider or identification lead | https://www.ecmwf.int/en/forecasts/datasets/complete-era5-global-atmospheric-reanalysis | Resolve the release and availability before selecting data. |
...
Global atmospheric reanalysis. Native and regridded distributions have different grids.
